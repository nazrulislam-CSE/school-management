...
{
    /* ================= Start AccountSalaryView Method ================= */
    ...
    /* ================= End AccountSalaryView Method ================= */

    /* ================= Start StudentFeeAdd Method ================= */
    public function AccountSalaryAdd(){

      return view('backend.account.employee_salary.employee_salary_add');
    }
    /* ================= End StudentFeeAdd Method ================= */

    /* ================= End AccountSalaryGetEmployee Method ================= */
    ...
    /* ================= Start AccountSalaryStore Method ================= */
    public function AccountSalaryStore(Request $request){
        ...
        if (!empty(@$data) || empty($checkdata)) {
            ...
            Session::flash('success','Well Done Data Successfully Updated');
