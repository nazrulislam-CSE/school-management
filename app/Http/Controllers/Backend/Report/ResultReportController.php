...
class ResultReportController extends Controller
{
    ...
    /* ================= End ResultView Method ================= */

    /* ================= Start ResultGet Method ================= */
    public function ResultGet(Request $request){
        ...
        Session::flash('error','Sorry These Criteria Does not match');
        return redirect()->back();
      }
    } // end Method 
    /* ================= End ResultGet Method ================= */

    /* ================= Start IdcardView Method ================= */
    public function IdcardView(){
        $data['years'] = StudentYear::all();
        $data['classes'] = StudentClass::all();
        return view('backend.report.idcard.idcard_view',$data);
    }
    /* ================= End IdcardView Method ================= */
