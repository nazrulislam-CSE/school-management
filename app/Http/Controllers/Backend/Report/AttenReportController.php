...
class AttenReportController extends Controller
{
    ...
    public function AttenReportGet(Request $request){
        ...
        Session::flash('error','Sorry These Criteria Donse not match');
        return redirect()->back();
    }


    } // end Method
    /* ================= End AttenReportGet Method ================= */
}
